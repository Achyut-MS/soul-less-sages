...
SRC = src-c/main.c src-c/md_parser.c src-c/html_serializer.c src-c/http.c src-c/file_writer.c src-c/platform.c src-c/tokenizer.c src-c/error_report.c src-c/logger.c
OBJ = $(SRC:.c=.o)
